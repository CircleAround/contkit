...
const AboutPage: React.FC<PageProps> = () => {
  const headingBaseCn = 'relative py-4 text-blue-600 text-center border-b border-blue-600 font-bold text-2xl bg-gradient-to-t from-blue-100/50'
      ...
      <Layout>
        <div className="py-8 pt-20">
          <div className="">
            ...
            <ul className="flex flex-col space-y-2 px-2 py-4 rounded-md bg-blue-100 list-disc	">
              <li className="">「概念」は動画で伝える</li>
              <li className="">実際にソースコードやブラウザを操作するところを通して「具体的にどういうものか」を伝える</li>
              <li className="">利用した<a href="https://github.com/CircleAround/pgonline" target="_blank" rel="noreferrer" className="text-blue-600 underline">ソースコードなどは動く形で公開</a>しておき、試せるようにしておく</li>
            </ul>
            <p className="">以上のような工夫に加えて、<a href="https://circlearound.co.jp" target="_blank" rel="noreferrer" className="text-blue-600 underline">運営者のサークルアラウンド社</a>ではプログラマーのトレーニング事業やシステムの受託開発を行っている経験から 「よくある誤解」を記したり「実際の開発でよく利用されるもの」をピックアップするなど、 無機質な言葉の説明だけに終わらないように努めています。</p>
